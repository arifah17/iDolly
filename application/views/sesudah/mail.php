...
<!-- mail -->
	...
	<div class="mail">
		<div class="container">
			...
			<p class="augue_agile">Critics are our friends, they show us our faults</p>
			...
			<div class="col-md-4 w3_agile_mail_right">
				<div class="w3layouts_mail_grid_left">
					...
					<div class="w3layouts_mail_grid_left2">
						<h3>Mail Us</h3>
						<a href="mailto:info@example.com">tutikcatering1@gmail.com</a>
					</div>
				...
				<div class="w3layouts_mail_grid_left">
					...
					<div class="w3layouts_mail_grid_left2">
						<h3>Address</h3>
						<p>Kandeg RT 04/RW 04 Waung, Baron, Nganjuk</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="w3layouts_mail_grid_left">
